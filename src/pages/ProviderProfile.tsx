      ...
      <main className="container py-4 space-y-4 max-w-3xl">
        ...
        {profileIncomplete && (
          <button
            ...
            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-primary/10 text-primary border border-primary/30 hover:bg-primary/20 transition"
